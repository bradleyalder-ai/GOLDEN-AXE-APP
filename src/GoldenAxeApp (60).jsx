...
function AxeTarget({ onScore, disabled }) {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: isTablet ? 20 : 12,
      width: "100%", height: isLandscape ? "100%" : "auto" }}>
      <svg
        viewBox="0 0 300 320"
        style={{ width: "100%", maxWidth: isLandscape ? "none" : isTablet ? 480 : 340,
          height: isLandscape ? "auto" : "auto",
          cursor: disabled ? "not-allowed" : "crosshair",
          filter: disabled ? "grayscale(0.6) opacity(0.7)" : "none", transition: "filter 0.3s" }}
    ...
    <div style={{ padding: isLandscape ? "8px 12px" : isTablet ? 24 : 16, maxWidth: isTablet && !isLandscape ? 1000 : "100%", margin: "0 auto" }}>
      {isLandscape && activeTarget ? (
        ...
        <div style={{ display: "flex", gap: 10, height: "100vh", boxSizing: "border-box", padding: "6px 8px" }}>
          ...
          {/* Right panel — target centered to score cards height, overflow hidden */}
