        ...
        {events.length > 0 && (
          <div style={{ marginBottom: 20 }}>
            <div style={{ color: "#888", fontFamily: "monospace", fontSize: 11,
              letterSpacing: 2, marginBottom: 10 }}>📅 TODAY'S EVENTS</div>
            {events.map(ev => (
              <div key={ev.id} onClick={() => handleEventJoin(ev)} style={{
                background: entering === ev.id ? shop.color : shop.bg,
                border: `2px solid ${entering === ev.id ? shop.accent : shop.color}`,
                ...
                <div style={{ flexShrink: 0, textAlign: "center", minWidth: 54 }}>
                  <div style={{ color: shop.accent, fontFamily: "monospace", fontWeight: "bold", fontSize: 14 }}>
                    {ev.time ? ev.time.slice(0,5) : "--:--"}
                  </div>
                </div>
                <div style={{ flex: 1 }}>
                  <div style={{ color: entering === ev.id ? "#fff" : shop.accent,
                    fontFamily: "monospace", fontWeight: "bold", fontSize: 16 }}>{ev.name}</div>
                </div>
                <div style={{ color: shop.accent, fontSize: 22 }}>
                  {entering === ev.id ? "⏳" : "›"}
                </div>
              </div>
            ))}
