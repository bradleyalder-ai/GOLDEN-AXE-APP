    ...
    <div style={{
      ...
      <div style={{ width: "100%", maxWidth: 380 }}>
        <div style={{ background: "#111", border: `1px solid #333`, borderRadius: 14, padding: 28 }}>
          <div style={{ color: GOLD, fontFamily: "monospace", fontSize: 13, fontWeight: "bold",
            marginBottom: 6, letterSpacing: 1 }}>GROUP CODE</div>
          <div style={{ color: "#666", fontFamily: "monospace", fontSize: 11, marginBottom: 16, lineHeight: 1.6 }}>
            Enter your group's code to join.<br/>
            All members with the same code share live data.
          </div>
          ...
          <input
            ...
            placeholder="e.g. GOLDAXE"
            maxLength={12}
            autoCapitalize="characters"
            style={{
              width: "100%", background: "#1a1a1a", border: `2px solid ${error ? RED : code.length >= 3 ? GOLD : "#333"}`,
              ...
              boxSizing: "border-box", marginBottom: 8, transition: "border-color 0.2s",
            }}
          />
          ...
          <button
            ...
            style={{
              width: "100%", background: code.length >= 3 ? GOLD : "#222",
              color: code.length >= 3 ? DARK : "#555",
          ...
          <div style={{ borderTop: "1px solid #222", marginTop: 20, paddingTop: 16 }}>
            <div style={{ color: "#444", fontFamily: "monospace", fontSize: 11, textAlign: "center", lineHeight: 1.8 }}>
              New group? Just invent a code and share it.<br/>
              League members use one code · Guests use another.
            </div>
          </div>
        </div>
      </div>
