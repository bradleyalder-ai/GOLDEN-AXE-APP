  ...
  return (
    <div style={{ padding: isLandscape ? "8px 12px" : isTablet ? 24 : 16, maxWidth: isTablet && !isLandscape ? 1000 : "100%", margin: "0 auto" }}>
      {isLandscape && activeTarget ? (
        ...
        <div style={{ display: "flex", gap: 12, height: "100vh", boxSizing: "border-box", paddingBottom: 8 }}>
          {/* Left panel — scores and info, compact */}
          <div style={{ width: "42%", display: "flex", flexDirection: "column", gap: 8, overflowY: "auto" }}>
            {headerBlock}
            {roundTabs}
            {soloBlock}
            {scoreBoard}
          ...
          {/* Right panel — target fills height */}
          <div style={{ flex: 1, display: "flex", flexDirection: "column", justifyContent: "center" }}>
            {throwLabel}
            <div style={{ flex: 1, display: "flex", alignItems: "center", maxHeight: "90vh" }}>
              {activeTarget}
            </div>
          </div>
        </div>
