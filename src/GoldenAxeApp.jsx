  ...
  if (!activeLeague) return (
    <div style={{ minHeight: "100vh", background: DARK, color: "#fff", padding: 20, maxWidth: 500, margin: "0 auto" }}>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
        ...
        <button onClick={createLeague} disabled={selectedPlayers.length < 2 || !leagueName.trim() || !isScorer}
          style={{ ...btnStyle(GOLD, DARK), opacity: (selectedPlayers.length < 2 || !leagueName.trim() || !isScorer) ? 0.5 : 1 }}>
          📅 Generate Schedule
        </button>
