          ...
          return (
            <div key={pl.id}
              ...
              style={{
                ...
                cursor:canTap?"pointer":"default", transition:"border 0.15s" }}>
              <div style={{ fontFamily:"monospace", fontSize:10, marginBottom:2,
                color:isCurrent?GOLD:canTap?"#aaa":"#888" }}>
                {podiumEntry ? MEDALS[podiumEntry.place-1] : canTap ? "👆 "+pl.name.slice(0,6) : pl.name.slice(0,8)}
              </div>
